      ...
      <section className="hero-parallax fixed top-0 left-0 w-full h-screen overflow-hidden bg-white">
        ...
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
          <img
            ...
            className="absolute bottom-0 right-0 w-[40%] h-auto object-contain opacity-50 hidden lg:block"
          />
        </div>
          ...
          <svg className="w-full h-full min-w-full" viewBox="0 0 1440 320" preserveAspectRatio="none" fill="none" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <linearGradient id="waveGradient" x1="0%" y1="0%" x2="100%" y2="0%">
                <stop offset="0%" stopColor="#7db3c9" stopOpacity="0.15" />
                <stop offset="25%" stopColor="#7db3c9" stopOpacity="0.25" />
                <stop offset="50%" stopColor="#7db3c9" stopOpacity="0.35" />
                <stop offset="75%" stopColor="#7db3c9" stopOpacity="0.25" />
                <stop offset="100%" stopColor="#7db3c9" stopOpacity="0.15" />
              </linearGradient>
            </defs>
